...
#  Default: ''
c.ServerApp.browser = 'google-chrome --app=%s'
...
#  Choices: any of ['sha512', 'sha256', 'sha1', 'sha3_224', 'md5', 'blake2b', 'blake2s', 'sha224', 'sha3_256', 'sha3_384', 'sha3_512', 'sha384']
#  Default: 'sha256'
